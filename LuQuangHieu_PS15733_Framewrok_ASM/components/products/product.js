...
app.controller('productController', function ($scope, $rootScope,
    ...
    // dùng http service
    $http.get('https://60ae432680a61f0017332d65.mockapi.io/api/v1/products')
    ...
    $scope.deleteProduct = function (id) {
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $http({
                        url: `https://60ae432680a61f0017332d65.mockapi.io/api/v1/products/${id}`,
                        method: "DELETE",
                    })
                        .then(function (response) {
...
app.controller('productFormController', function ($scope, $rootScope, $location,
    ...
    if ($scope.productId) {
        $http.get(`https://60ae432680a61f0017332d65.mockapi.io/api/v1/products/${$scope.productId}`)
            .then(function (response) {
    ...
    $scope.submitForm = function () {
        ...
        if ($scope.productId) {
            ...
            $http({
                url: `https://60ae432680a61f0017332d65.mockapi.io/api/v1/products`,
                method: "POST",
                data: { name, price, quantity, description, image }
            })
                .then(function (response) {
